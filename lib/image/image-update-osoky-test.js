...
describe("updating", function () {
	var _id;
	var _files;
	it("given image1 uploaded", function (next) {
		upload.upload('samples/5120x2880-169.jpg', function (err, files) {
			_files = files;
			next(err);
		});
	});
	it("given image1", function (next) {
		this.timeout(10000);
	...
	it("given image2 uploaded", function (next) {
...
describe("updating with small", function () {
	...
	it("given small uploaded", function (next) {
...
describe("updating with text file", function () {
	...
	it("given text uploaded", function (next) {
